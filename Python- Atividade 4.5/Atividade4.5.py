...
# cnplot = ax.contourf(clim.lon, clim.lat, clim, cmap='YlGnBu', extend='max')
...
def create_plot(ax, nrow, ncol, data, tlon, season=''):
    ...
    cnplot = ax.contourf(data.lon, data.lat, data.sel(season=season), cmap='YlGnBu', extend='max')  # Cria um plot de contorno
